 ...
 */
public class RunApplication extends AbstractRunApplication{
	 ...
	 */
	public RunApplication(SVGPicture picture, String projectName, Container parent, 
	...
	protected void initializeAction() {
		...
		try{
			toolTipText=bundle.getString("tooltip_runApplication")+
				"<i>"+actionElement.getAttribute(commandAttributeName)+"</i>";
		}catch (Exception ex){}
	}
}
