...
public class PDFExportDialog extends ExportDialog{
		...
		widthSpinner.addChangeListener(new ChangeListener(){
			...
			public void stateChanged(ChangeEvent evt) {
				...
				if(pageSize==null) {
					...
					pageSize=new com.itextpdf.text.Rectangle((float)((Double)widthSpinner.getValue()).doubleValue(), 0.0f);

				}else {

					pageSize=new com.itextpdf.text.Rectangle((float)((Double)widthSpinner.getValue()).doubleValue(), pageSize.getHeight());
				}
			}
		});
		...
		heightSpinner.addChangeListener(new ChangeListener(){
			...
			public void stateChanged(ChangeEvent evt) {
				...
				if(pageSize==null) {
					...
					pageSize=new com.itextpdf.text.Rectangle(0.0f, (float)((Double)heightSpinner.getValue()).doubleValue());

				}else {

					pageSize=new com.itextpdf.text.Rectangle(pageSize.getWidth(), (float)((Double)heightSpinner.getValue()).doubleValue());
				}
			}
		});
			...
			public void stateChanged(ChangeEvent evt) {
				...
				if(lastSelectedButton==null || (lastSelectedButton!=null && ! lastSelectedButton.equals(evt.getSource()))) {
					...
					if(evt.getSource().equals(predefinedRadioButton) && predefinedRadioButton.isSelected()) {
						...
						pageSize=new com.itextpdf.text.Rectangle(    (float)((Double)widthSpinner.getValue()).doubleValue(), 
	...
	protected static class PredefinedPageSizeItem{
		 ...
		 */
		protected static LinkedHashMap<com.itextpdf.text.Rectangle, String> sizeToLabel=
			new LinkedHashMap<com.itextpdf.text.Rectangle, String>();
		...
		static {
			...
			com.itextpdf.text.Rectangle itemSize=null;
			LinkedList<com.itextpdf.text.Rectangle> sizes=
				new LinkedList<com.itextpdf.text.Rectangle>(sizeToLabel.keySet());
		 ...
		 */
		protected com.itextpdf.text.Rectangle size=PageSize.A4;
		 ...
		 */
		private PredefinedPageSizeItem(com.itextpdf.text.Rectangle size) {
		 ...
		 */
		public com.itextpdf.text.Rectangle getSize() {
			return size;
		}
		 ...
		 */
		protected static LinkedHashMap<com.itextpdf.text.Rectangle, String> getPageSizeToLabel() {
			return sizeToLabel;
		}
		 ...
		 */
		protected static PredefinedPageSizeItem getItem(com.itextpdf.text.Rectangle pageSize) {
