...
public class PathShapeItemsHandler {
	 ...
	 * the labels
	 */
	protected String itemLabel, itemTooltip, addPointLabel, addPointTooltip, removePointLabel,
			removePointTooltip;

	/**
	 * the menu items that will be added to the menu bar
	 */
	protected JMenuItem shapeCreatorMenuItem, addPointMenuItem, removePointMenuItem;
	...
	protected void createItems() {
		...
		if (pathShapeModule.isAddRemoveElementEnabled()) {
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				} else if (pathShapeModule.isAddRemoveElementEnabled()
						&& e.getSource().equals(addPointMenuItemTool)) {
		...
		toolButton.setSize(40, 40); //Oliver
		toolButton.setPreferredSize(new Dimension(40,40));
		toolButton.setMinimumSize(new Dimension(40,40));
	...
	/**
	 * sets the current tool item in the toolbar according to the provided mode
	 * 
	 * @param mode
	 */
	...
	/**
	 * @return the tool item containing the menu items for the path shape module
	 */
