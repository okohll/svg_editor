...
public class EditorMenuBar extends JMenuBar {
	 ...
	 */
	private LinkedHashMap<String, JMenuItem> menuItems = new LinkedHashMap<String, JMenuItem>();

	/**
	 * the HashMap associating the name of a menu to a linked list of menu items
	 */
	private LinkedHashMap<String, LinkedList<JMenuItem>> unknownMenuItems = new LinkedHashMap<String, LinkedList<JMenuItem>>();
	...
	/**
	 * builds the menubar given the order of menu items specified in the XML
	 * file
	 */
	public void build() {
					...
					if (current != null && current instanceof Element) {
						...
						if (name != null) {
							...
							if (name.equals("menu")) {
								...
								// finds and adds the menu item to the current
								// menu
								att = ((Element) current).getAttribute("name");
	...
	/**
	 * parses the document to get the menu and menu items specified in the
	 * "menu.xml" file
	 */
