 ...
 * 
 *         the class allowing to display a frame containing the components used
 *         for modifying the svg elements
 */
public class ToolsFrame {
	...
	public ToolsFrame(final Editor editor, String id, String label, final JPanel toolPanel) {
		...
		internalFrame.getContentPane().setLayout(
				new BoxLayout(internalFrame.getContentPane(), BoxLayout.X_AXIS));
		...
		final Runnable runnable = new Runnable() {
			...
			public void run() {
				...
				Point location = SwingUtilities.convertPoint(frameButton.getParent(),
						frameButton.getLocation(), editor.getDesktop());
