...
/**
 * the class of the record data action
 * @author ITRIS, Jordi SUC
 */
public class AbstractButtonRecordData extends AbstractRecordData{
	 ...
	 */
	public AbstractButtonRecordData(SVGPicture picture, String projectName, Container parent, 
