 ...
 */
public class AbstractButtonSendCommand extends AbstractSendCommand{
	 ...
	 */
	public AbstractButtonSendCommand(SVGPicture picture, String projectName, Container parent, 
