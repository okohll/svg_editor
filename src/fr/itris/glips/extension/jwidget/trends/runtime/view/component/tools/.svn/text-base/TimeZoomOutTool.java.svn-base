...
import fr.itris.glips.extension.jwidget.trends.runtime.TrendsBundle;
import fr.itris.glips.extension.jwidget.trends.runtime.TrendsIcons;
 ...
 */
public class TimeZoomOutTool extends JButton{
	
	/**
	 * the id
	 */
	private String id="TimeZoomOut";
	 ...
	 */
	public TimeZoomOutTool(ToolBarComponent toolBar){
	...
	protected void build(){
		...
		listener=new ActionListener(){
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if(newDuration>configuration.getMaxDisplayableTime()){
					
					newDuration=configuration.getMaxDisplayableTime();
				}
