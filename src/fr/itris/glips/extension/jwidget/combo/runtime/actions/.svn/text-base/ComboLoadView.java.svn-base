 ...
 */
public class ComboLoadView extends AbstractLoadView{
	 ...
	 */
	public ComboLoadView(SVGPicture picture, String projectName, Container parent, 
	...
	protected void initializeAction() {
		...
		try{
			toolTipText=bundle.getString("tooltip_loadView");
		}catch (Exception ex){}
        ...
        //filling the combo box with the combo items corresponding to each view path
    			...
    			SwingUtilities.invokeLater(new Runnable(){
    				...
    				public void run() {
    			        ...
    			        for(int i=0; i<combo.getItemCount(); i++){
    			        	...
    			        	comboItem=(ComboListItem)combo.getItemAt(i);
