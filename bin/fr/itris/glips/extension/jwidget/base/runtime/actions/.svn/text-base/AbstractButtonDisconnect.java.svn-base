...
/**
 * the class of the disconnect action
 * @author ITRIS, Jordi SUC
 */
public class AbstractButtonDisconnect extends AbstractDisconnect{
	 ...
	 */
	public AbstractButtonDisconnect(SVGPicture picture, String projectName, Container parent, 
